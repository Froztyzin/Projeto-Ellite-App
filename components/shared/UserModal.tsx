...
const UserModal: React.FC<UserModalProps> = ({ isOpen, onClose, onSave, user, isSaving }) => {
    ...
    const assignableRoles = [Role.FINANCEIRO, Role.RECEPCAO, Role.INSTRUTOR];
                ...
                <form onSubmit={handleSubmit} className="p-4 sm:p-5 overflow-y-auto">
                    <div className="grid gap-4 mb-4 grid-cols-1 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select 
                                name="role" id="role" value={formData.role} onChange={handleChange} disabled={isRoleSelectDisabled}
